...
function SignupPage({ goToLogin, goToOnboarding }) {
  ...
  return (
    <main className="fauth-page">
      ...
      <section className="fauth-card fauth-card-signup">
        <p className="fauth-signup-badge">New learner setup</p>
        <p className="fauth-card-brand">Fluentia</p>
        <h1>Create your account</h1>
        <p className="fauth-subtitle">
          Pick your language goals, create your profile, and start your personalized onboarding.
        </p>

        <form className="fauth-form" onSubmit={handleSubmit}>
          <label className="fauth-input-row fauth-input-row-text">
          ...
          <label className="fauth-checkbox-row fauth-signup-check">
            <input type="checkbox" required />
            <span>I agree to the Terms and Privacy Policy.</span>
          </label>

          <button type="submit" className="fauth-submit-btn">Create account</button>
        </form>
