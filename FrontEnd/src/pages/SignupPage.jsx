...
function SignupPage({ goToLogin, goToOnboarding }) {
  useEffect(() => {
    ...
    <main className="fauth-page">
      ...
      <section className="fauth-card">
        ...
        <form className="fauth-form" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="fauth-submit-btn">Get Started</button>
        </form>
        ...
        <div className="fauth-social-row">
          <button type="button" className="fauth-social-btn fauth-social-btn-google" aria-label="Sign in with Google">
          ...
          <button type="button" className="fauth-social-btn fauth-social-btn-facebook" aria-label="Sign in with Facebook">
            <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <button type="button" className="fauth-social-btn fauth-social-btn-apple" aria-label="Sign in with Apple">
            <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <p className="fauth-form-note">
          Already have an account? <a href="/login" onClick={handleGoToLogin}>Log in</a>
        </p>
      </section>
    </main>
  );
