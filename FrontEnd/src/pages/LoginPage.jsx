...
function LoginPage({ goToSignup, goToOnboarding }) {
  useEffect(() => {
    ...
    <main className="fauth-page">
      ...
      <section className="fauth-card fauth-card-compact">
        ...
        <div className="fauth-social-row">
          <button type="button" className="fauth-social-btn fauth-social-btn-google" aria-label="Log in with Google">
          ...
          <button type="button" className="fauth-social-btn fauth-social-btn-facebook" aria-label="Log in with Facebook">
            <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <button type="button" className="fauth-social-btn fauth-social-btn-apple" aria-label="Log in with Apple">
            <svg viewBox="0 0 24 24" aria-hidden="true">
